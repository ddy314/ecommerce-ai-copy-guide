      ...
      <div ref="box" class="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4 bg-page">
        ...
        >
          ...
          >
            ...
            >
              {{ msg.sender_role === 'user' ? '我' : msg.sender_role === 'ai' ? 'AI' : '商' }}
            </div>
            <div class="max-w-[78%]">
              <div
              ...
              <div
                class="inline-block px-4 py-2.5 rounded-2xl text-sm max-w-full whitespace-pre-wrap leading-relaxed shadow-sm"
                :class="msg.sender_role === 'user'
                  ? 'bg-gradient-to-r from-primary to-primary-dark text-white rounded-br-sm'
                  : msg.sender_role === 'ai'
                    ? 'bg-green-50 text-gray-800 border border-green-100 rounded-bl-sm'
